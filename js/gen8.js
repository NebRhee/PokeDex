...
const number_gen2_start = 810
const number_gen2_end = 898
let pokemon_objects = []
...
function getDescription(pokemon_species) {
    let description = pokemon_species.flavor_text_entries[7].flavor_text//.replace(/(\r\n|\n|\r)/gm, "")
    if (pokemon_species.flavor_text_entries[7].language.name != "en") {
